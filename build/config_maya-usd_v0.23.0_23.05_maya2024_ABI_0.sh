...
deploy_dir="${deploy_root}/USD/autodesk/mayausd_v${MAYAUSD_VER}_${USD_VER}_${MAYA_VER}_ABI_0"
...
# export PXR_USD_LOCATION="${deploy_root}/USD/pixar/USD-v${USD_VER}_rman${RMAN_VER}"
...
# export MaterialX_DIR="${deploy_root}/MaterialX/MaterialX-v1.38.5"
